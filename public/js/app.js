...
// Verifica cuando el navegador cambia a online, o a offline.
window.addEventListener('online', isOnline );
window.addEventListener('offline', isOnline );

// verifica estado cuando se inicia la app
isOnline();
...
// Cancelar Suscripcion a las notificaciones
...
btnLocation.on('click', () => {
    ...
    if(!navigator.geolocation){
        $.mdtoast('La geolocalización no es una función soportada por el navegador.', {
...
if( navigator.share ) {
    console.log('Navegador soporta share api');
} else {
    console.log('Navegador no soporta share api');
}

// jQuery, le agrego el listener click a los 'li' item de lista 
timeline.on('click', 'li', function(){

    console.log('click en LI');
    console.log($(this)); // elemento html del nodo 
    console.log($(this).data('tipo')); // elemento html del nodo 
    console.log($(this).data('user')); // elemento html del nodo 
...
// ===============================================================
// FIN Sección 11 - Recursos Nativos
// ===============================================================
